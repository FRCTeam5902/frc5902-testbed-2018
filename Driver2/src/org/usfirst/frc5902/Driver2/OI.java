...
public class OI {
    ...
    public JoystickButton BA1;
    public JoystickButton BX3;
    ...
    public OI() {
        ...
        BA1 = new JoystickButton(xbox, 1);
        BA1.whileHeld(new testMotor());
        BX3 = new JoystickButton(xbox, 3);
        BX3.whileHeld(new testMotor());
