...
public class OI {
    ...
    public OI() {
        ...
        joystickButton8.whenPressed(new autoBaseline(1)); // REVISIT
        
        //Light button on Arcade Controller - Comment Out this code for competition
        joystickButton3 = new JoystickButton(AC, 1);
        joystickButton3.whileHeld(new intakeAndWheelDrive(.25));
        ...
        SmartDashboard.putData("Position 1", autoBaseline.getInstance(1));
        SmartDashboard.putData("Position 2", autoBaseline.getInstance(2));
        SmartDashboard.putData("Position 3", autoBaseline.getInstance(3));
